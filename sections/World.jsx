  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <TitleText
        title={
          <>
            Track friends around the world and invite them to play together in
            the same world
...
bg-[#5d6680] ">
  ...
  <img src="people-01.png"
   ...
   className="w-full h-full animate-bounce"
    />
     <p className=" mt-5 text-white leading-8">Available </p>
...
bg-[#5d6680] ">
  ...
  <img src="people-02.png"
   ...
   className="w-full h-full animate-ping"
    />
    <p className=" mt-5 text-white leading-8">Pairing</p>
...
bg-[#5d6680] ">
  ...
  <img src="people-03.png"
   ...
   className="w-full h-full animate-pulse"
    />
     <p className=" mt-5 text-white leading-8">Not Available</p>
